package before;// name: Jeong Seung Yeon, id: 20192447, class: Na
...
//            count++;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*** before.print the only field chars of this class ***");
        lines.print();
        System.out.println("*** before.print the only field chars of this class ***");
        ...
        System.out.println("*** when the 1st line > the 2nd line, before.print 1 ***");
        System.out.println("*** when the 1st line = the 2nd line, before.print 0 ***");
        System.out.println("*** when the 1st line < the 2nd line, before.print -1 ***");
        ///System.out.println(lines.compareLines(0, 1));
        System.out.println("*** compare the 1st line and 2nd line ***");

        System.out.println("*** sort lines and before.print***");
        ///lines.sortLines();
        lines.print();
        System.out.println("*** sort lines and before.print***");
        ...
        ///before.Characters split = new before.Characters(tokens);
        ///split.before.print();
        System.out.println("*** split the field chars with delimiter 's' ***");
    }
